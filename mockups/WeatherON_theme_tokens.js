export const WEATHERON_THEMES = {
  dark: {
    ...
    inkRgb: "248,251,255",
    mistRgb: "215,230,245",
    gradient: "linear-gradient(175deg, #17365D 0%, #2A5D8F 54%, #4AA3DF 120%)",
    phoneShadow: "0 0 0 1.5px rgba(255,255,255,0.08), 0 34px 70px rgba(0,0,0,0.46), 0 8px 22px rgba(0,0,0,0.28)",
  },
  light: {
    mode: "light",
    shellBg: "#E7F1F8",
