...
try {
  ...
  for (const viewport of viewports) {
    ...
    console.log(`small-screen: ${viewport.name}/notification-center`);
    await clickText(page, "홈");
    console.log(`small-screen: ${viewport.name}/notification-center home`);
    ...
    await screenshot(page, viewport, "notification-center");
    console.log(`small-screen: ${viewport.name}/notification-center screenshot`);

    console.log(`small-screen: ${viewport.name}/alert-settings`);
    await clickAriaIncludes(page, "알림 설정");
