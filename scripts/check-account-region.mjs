...
assert.equal(resolveAccountRegion({ locale: "ko-KR" }), "KR");
assert.equal(resolveAccountRegion({ locale: "ja-JP" }), "JP");
assert.equal(resolveAccountRegion({ locale: "ko-US" }), "GLOBAL");
assert.equal(resolveAccountRegion({ locale: "en-KR" }), "KR");
