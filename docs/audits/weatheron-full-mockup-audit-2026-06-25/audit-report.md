...
2026-06-29 기획안 피드백 반영 후 MVP 기준 문서는 `docs/planning/WeatherON_기능_출시_로드맵.md`로 둔다.
MVP 1차는 전체 기능 출시가 아니라 출발시간 역산, 목적지 날씨 비교, 비 시작/그침 타임라인과 알림 신뢰성 검증으로 좁힌다.

목업 기준 우선 화면은 다음만 잡는 게 좋음.
...
- 해당 PRD는 2026-06-29 피드백 반영 후 MVP 0~1, Beta, v1.0, v1.1+ 출시 단계와 연결되도록 갱신함.
- 코디, 우산, 신발 추천은 MVP의 주 기능이 아니라 홈 판단을 돕는 보조 기능으로 둠.
