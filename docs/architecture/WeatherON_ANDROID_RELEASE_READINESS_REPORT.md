...
| 최신 production build 상태 | LOCAL BUILD SUCCESS / EAS IN_QUEUE |
...
| Preview APK 소스 일치 | 확인 필요 | 0.1.0 (7) vs 0.1.0 (8) |
...
| `npm run check:eas-production-build-status -- 5d7ddb0e-334d-4663-bfa9-5a90d50eb8f1` | 확인 필요 |

## 4. 다음 작업

1. 현재 소스 0.1.0 (8) 기준 새 preview APK 필요. 사용자 승인 후 `npm run build:android:preview:no-wait` 실행
...
7. `5d7ddb0e-334d-4663-bfa9-5a90d50eb8f1` production AAB 완료 대기 후 artifact 확인
