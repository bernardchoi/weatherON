...
| 최신 preview build version | `0.1.0 (9)` |
...
| Preview APK 소스 일치 | 확인 필요 | 0.1.0 (9) vs 1.0.0 (10) |
...
| `npm run check:eas-production-build-status -- f66ecb78-ad9d-4236-be70-ec3530a051f8` | 통과 |

## 4. 다음 작업

1. 현재 소스 1.0.0 (10) 기준 새 preview APK 필요. 사용자 승인 후 `npm run build:android:preview:no-wait` 실행
...
7. `f66ecb78-ad9d-4236-be70-ec3530a051f8` AAB artifact를 Play Console 업로드 후보로 확인
