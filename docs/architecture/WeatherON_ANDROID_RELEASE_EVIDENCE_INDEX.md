...
| production build | `cb4fcc5f-1682-41d3-acae-64f951ced653` / FINISHED |
| artifact 접근 issue | 0 |
| Play 제출 blocker | 17 |
| 실기기 QA 미검증 | 0 |
| 스토어 스크린샷 issue | 0 |
...
| Production AAB | `cb4fcc5f-1682-41d3-acae-64f951ced653` | FINISHED | https://expo.dev/artifacts/eas/9V4hpFeSRtRBF6pKH1q0l1tHtHU9GebrUup35Zgf_dk.aab |
