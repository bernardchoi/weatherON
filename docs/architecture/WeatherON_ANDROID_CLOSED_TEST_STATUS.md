...
4. 14일 운영 기간 안에 코디 추천/상세/저장 gate/옷장 프리셋 포함 build로 전환한다.
5. 최신 APK QA 통과 후 필요한 트랙에 업로드한다.
6. 개인정보처리방침 공개 URL을 Play Console에 입력한다.
...
- 폐쇄 테스트 종료일 확정 필요
- 최신 APK QA 1차 통과 필요
- 코디 포함 build 전환 및 C1/C4/C2/C3 QA 필요
