...
| Build 상태 | FINISHED |
| Build 버전 | `0.1.0 (6)` |
| 소스 일치 | 불일치 - package 변경 후 production AAB 재빌드 필요 |
...
| 업로드 후보 여부 | 불가 - `com.weatheron.mobile` production AAB 재빌드 필요 |
...
- AAB는 소스 기준 버전과 Android package가 모두 일치할 때만 Play 테스트 트랙 업로드 후보로 본다.
