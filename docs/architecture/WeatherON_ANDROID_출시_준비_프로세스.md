...
- 공개 테스트 AAB는 Android `versionCode=19` 기준으로 생성한다.
...
| 2026-08-09 | Android 공개테스트 AAB `1.0.0 (16)` 빌드를 위해 Android `versionCode=16` 반영 |
| 2026-09-06 | Android 공개테스트 AAB `1.0.0 (17)` 빌드를 위해 Android `versionCode=17` 반영 |
| 2026-09-06 | 선택적 카메라 기능 선언 후 Android 공개테스트 AAB `1.0.0 (18)` 재빌드 기준 반영 |
| 2026-09-13 | 최신 변경 포함 Android 공개테스트 AAB `1.0.0 (19)` 빌드 기준 반영 |
