...
- 홈 판단 CTA와 목적지/알림 설정 클릭 흐름은 `npm run check:android-core-flow`로 반복 확인한다.
...
| 핵심 클릭 흐름 | `npm run check:android-core-flow`로 홈 3개 CTA, 목적지 검색/저장, 알림 설정 반영 확인 |
...
| 2026-06-28 | In-app browser 390x844에서 하단 탭 `홈/출발/MY` 확인 |
