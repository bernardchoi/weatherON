...
| 고객센터 연락처 | support@weatheron.app | 확정 |
| 개인정보 보호책임자 성명 | 최대현 | 확정 |
| 개인정보 보호책임자 직책 | 개인정보 보호책임자 | 확정 |
| 개인정보 보호책임자 연락처 | support@weatheron.app | 확정 |
| 개인정보처리방침 시행일 | 비공개 테스트 시작일 | 확정 |
| 광고/사용 로그 보유기간 | 테스트 종료 후 1개월 | 확정 |
| 이메일 인증 발송 서비스 | 현재 이메일 인증 발송 서비스를 사용하지 않습니다. | 확정 |
...
| 2026-07-06 | 개인정보처리방침 운영자/연락처/보관기간 입력값 반영 |
