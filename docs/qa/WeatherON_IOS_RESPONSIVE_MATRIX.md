...
| P0 | 홈·날씨 | H1, H2, H3, H4, H5, H6, H7 | 카드 밀도, 사이드 패널, 차트 | 대기 | 대기 | 대기 | 대기 |
| P0 | 코디·옷장 | C1, C2, C3, C4 | 2열 카드, 이미지 비율, 상세 CTA | 대기 | 대기 | 대기 | 대기 |
...
| 개별 화면 | 홈 이후 고정 높이·2열 카드·차트 최적화는 매트릭스 순서대로 후속 적용 |
