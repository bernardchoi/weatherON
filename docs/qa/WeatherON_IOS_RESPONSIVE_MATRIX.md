...
| P0 | 목적지 | G1, G2, P1 | 검색 결과, 시간 선택, 고정 CTA | 부분 | 부분 | 부분 | 대기 |
| P0 | MY·설정 | M1, M2, M3, M4 | 설정 행, 스위치, 하단 내비게이션 | 부분 | 부분 | 부분 | 대기 |
| P1 | 계정·약관 | A2, A3, A4, R1, R2 | 폼, 긴 문서, 고정 CTA | 대기 | 대기 | 대기 | 대기 |
...
| 개별 화면 | 계정·약관 이후 고정 높이·2열 카드 최적화는 매트릭스 순서대로 후속 적용 |
