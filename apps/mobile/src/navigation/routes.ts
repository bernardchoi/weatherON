...
export function isLaunchHiddenRoute(route: AppRouteId): boolean {
  return launchHiddenRouteIds.has(route);
}

export function isLaunchVisibleP0Route(route: AppRouteId): route is P0RouteId {
  return isP0Route(route) && !isLaunchHiddenRoute(route);
}
